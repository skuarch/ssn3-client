...
import view.charts.BarChartHorizontal;
 ...
 * @author skuarch
 */
public class BarChartHorizontalPanel extends FactoryPanel {

    private Notifications notifications = null;
    private BarChartHorizontal barChart = null;
    ...
    private String titleChart = null;
    private Footer footer = null;

    //==========================================================================
    public BarChartHorizontalPanel(SubPiece subPiece) {
    ...
    //==========================================================================
    public void setEnableDropTarget(boolean flag){
    ...
    //==========================================================================
    public void showPagination(boolean flag) {
        this.showPagination = flag;

        if (panelPagination != null) {
            panelPagination.setVisible(flag);
        }
    ...
    private void createChart() {
        barChart = new BarChartHorizontal(dataset, subPiece.getView(), "hops", "miliseconds", list);
    } // end createChart
    ...
    //==========================================================================
    public void setEnableTableButtonFooter(boolean flag){
       footer.setEnableTableButton(flag);
    } // end setEnableTableButtonFooter
    
    //==========================================================================
    public void setEnableExportButtonFooter(boolean flag){       
       footer.setEnableExportButton(flag);
    } // end setEnableTableButtonFooter
    
    //==========================================================================
    public void setEnableList(boolean flag){
        this.list.setEnabled(flag);
        footer.setEnableList(flag);
    }
