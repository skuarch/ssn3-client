 ...
 * @author skuarch
 */
public class ThreadThreshold extends Thread {

    private String server = null;
    private ArrayList<DefaultMutableTreeNode> arrayNodes = null;
    
    //==========================================================================
    public ThreadThreshold(String server, ArrayList<DefaultMutableTreeNode> arrayNodes){
        this.server = server;
    ...
    public void run() {
        ...
        try {
            ...
            connectivity = new ThresholdCapturesConnectivity().requestConnectivity(server);
